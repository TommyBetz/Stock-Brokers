...
# function to extract sentiment from text using TextBlob                               
...
def main(inputs,output):
    ...
    # retain only AAPL related news
    df_filtered_data = df_filtered_data.filter(df_filtered_data.company=='AAPL')
    ...
    # join df_summary and df_median on date
    df_summary = df_summary.join(df_median, ['Date'])
    # join df_sentiment with df_summary
