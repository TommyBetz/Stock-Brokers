# Financial times dataset 01-2018 to 05-2018
import sys
...
lst_companies = ['apple','facebook'] # companies to analyse
...
# Convert the pre existing textual sentiment to a numerical value
def sentiment(x):
	str_company = x[0]
	lst = x[1].split(',')
	lst_temp = lst[0]
...
def main(inputs,output):
	...
	# do this loop for each company to analyze
